...
\begin{itemize}
  \pbodyitem{Monolithic}{
    ...
    This simplifies the complexity of interacting with the host operating system by reducing the abstract footprint of the application.
    In summary: the system needs only manage a single executable element, eliminating the need to implement IPC-, or networking-related requirements.
    This decision does impact potential performance, as discussed in \prettyref{sec:alt_dist_comp}.
  }


  \pbodyitem{Layered}{
    Within the monolithic system, subsystems are composed of functionality as layers.
    This method of design is an attempt to mitigate the complexity of the system by reducing the possible interaction between sub-systems.
