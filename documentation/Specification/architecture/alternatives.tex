...
\begin{itemize}
  ...
  \pbodyitem{AI Platforms}{
    ...
    This approach is not considered in the current form of the design, but it may be possible in the future to create training data from 3-D renders, merged with a "wMidjourney"-like model.
    This approach would also need to carefully consider the problem of compatibility since interfaces such as ROCm or CUDA are both common candidate platforms and have had mixed support in other systems.
  }
\end{itemize}